...
public class AppUsageStatisticsActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            int hasPakcageUsagesStatPermission = checkSelfPermission( Manifest.permission.PACKAGE_USAGE_STATS );
            if( hasPakcageUsagesStatPermission != PackageManager.PERMISSION_GRANTED ) {
